...
## 1️⃣ Arquivo [Dockfile](/Sprint4/Desafio/Etapa-1/Dockerfile) para executar o código [carguru.py](/Sprint4/Desafio/Etapa-1/app/carguru.py)

- Primeiramente, foi salvo o código [carguru.py](/Sprint4/Desafio/Etapa-1/app/carguru.py) dentro do diretório app
- Após isso, foi criado o arquivo `Dockfile` para gerar uma imagem, em que utilizei como base a imagem python3
```
FROM python:3
...
```
- Para criar a imagem e o container foram utilizados os seguintes comando, respecticamente:
```
...
```
## 2️⃣ Após pesquisas, concluí que é possivel sim reutilizar um dos containers parados e não precisar criar novos para executar novamente a imagem. O comando é:
```
